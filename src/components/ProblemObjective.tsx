            ...
            <div className="space-y-8 text-[var(--color-brand-dark)]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Capacitar você para atuar com 100% de confiança em perícias e licenciamentos complexos.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Metodologia focada em estudos de caso e elaboração de laudos reais para o mercado.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Dominar as exigências regulatórias e as normas internacionais (ISO 14001, 19011).</p>
                </div>
              </div>
            </div>
