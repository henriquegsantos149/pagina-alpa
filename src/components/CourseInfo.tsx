    ...
    <section className="relative py-16 md:py-24 bg-[var(--color-brand-light)] text-[var(--color-brand-dark)] border-y border-slate-200/80">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          {/* Card 3 */}
          <motion.div variants={item} className="shape-leaf bg-white border border-slate-200/80 p-8 hover:border-[var(--color-brand-accent)]/50 hover:shadow-md hover:shadow-slate-200/50 transition-all group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-24 h-24 bg-brand-gradient opacity-10 rounded-full blur-[40px] group-hover:opacity-30 transition-opacity"></div>
            <div className="w-14 h-14 shape-leaf bg-slate-100 flex items-center justify-center mb-6 border border-slate-200 group-hover:border-[var(--color-brand-accent)]/50 transition-colors">
            ...
            <p className="text-3xl font-impact tracking-wider text-brand-gradient leading-tight">100% EAD<br/><span className="text-sm font-secondary tracking-normal text-[var(--color-brand-dark)]/70 uppercase">Aulas Gravadas</span></p>
          </motion.div>
